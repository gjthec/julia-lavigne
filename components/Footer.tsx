      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start mb-20 gap-16">
          <div className="max-w-sm">
            ...
            <div className="flex gap-4">
              <div className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center hover:border-[#c5a059] transition-colors cursor-pointer group">
                <span className="text-gray-500 group-hover:text-[#c5a059] text-xs">In</span>
              </div>
              <div className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center hover:border-[#c5a059] transition-colors cursor-pointer group">
                <span className="text-gray-500 group-hover:text-[#c5a059] text-xs">Ig</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12 md:gap-24">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors text-xs uppercase tracking-widest">Dúvidas</a>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-gray-600 text-[10px] font-bold uppercase tracking-[0.2em]">
            © 2026 — Dra. Advocacia | Todos os direitos reservados.
          </p>
